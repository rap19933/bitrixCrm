window.JCH2oBuyOneClickNotPopup = function (arParams) {
	var self = this;
...
window.JCH2oBuyOneClickNotPopup.prototype.reInit = function (arParams) {
	this.params = arParams;
	this.initConfig();
	this.InitOffers();
};

window.JCH2oBuyOneClickNotPopup.prototype.initConfig = function () {
...
window.JCH2oBuyOneClickNotPopup.prototype.AjaxSubmit = function (postArray, link, dataType, successFunction) {
	var self = this;
	if(link === undefined){
...
window.JCH2oBuyOneClickNotPopup.prototype.ArrayIntersect = function(arr0) {
  var retArr = [];
...
window.JCH2oBuyOneClickNotPopup.prototype.UpdateMask = function () {
	var self = this;
...
window.JCH2oBuyOneClickNotPopup.prototype.SetQuantity = function (e) {
	e.preventDefault();
	var cur_val,
			element = e.target;
...
window.JCH2oBuyOneClickNotPopup.prototype.ChangeOffer = function (e){
	var self = this,
			element = e.target;
	var price_container = $(element).closest("form").find(".item_current_price");
	var cur_quantity = 1;
...
window.JCH2oBuyOneClickNotPopup.prototype.ChangeOfferProp = function (e){
	var self = this,
			element = e.target,
...
window.JCH2oBuyOneClickNotPopup.prototype.H2osaveConsent = function (item, callback){
	 ...
	 */
window.JCH2oBuyOneClickNotPopup.prototype.h2ob1cgetXmlHttp = function(){
	var xmlhttp;
	try {
 ...
 * @param addValue
 */
window.JCH2oBuyOneClickNotPopup.prototype.h2ob1csendForm = function(form, link, addValue){
...
window.JCH2oBuyOneClickNotPopup.prototype.ShowBlockModal = function () {
  $(this.blockModal).show();
};

window.JCH2oBuyOneClickNotPopup.prototype.HideBlockModal = function () {
  $(this.blockModal).hide();
};

window.JCH2oBuyOneClickNotPopup.prototype.SubmitForm = function (e) {
	e.preventDefault();
	var self = this,
			form = e.target,
...
window.JCH2oBuyOneClickNotPopup.prototype.InitEvents = function () {
	var self = this;
...
window.JCH2oBuyOneClickNotPopup.prototype.InitLocation = function () {
	var self = this;
...
window.JCH2oBuyOneClickNotPopup.prototype.InitConsument = function () {
	var self = this;
	if (!!BX.UserConsent) {
...
window.JCH2oBuyOneClickNotPopup.prototype.getFirstKey = function (arr) {
	var key;
...
window.JCH2oBuyOneClickNotPopup.prototype.getPossibleOffers = function (code, value) {
...
window.JCH2oBuyOneClickNotPopup.prototype.filterSelector = function (text) {
  return text.replace(/ /g,"_").replace(/\*/g,"_").replace(/&quot;/g,'_').replace(/\./g,"_").replace(/:/g,"_").replace(/\"/g,'_');
};

window.JCH2oBuyOneClickNotPopup.prototype.InitOffers = function () {
...
window.JCH2oBuyOneClickNotPopup.prototype.DisabledOffers = function () {
	var
		key,
		codeProp,
...
window.JCH2oBuyOneClickNotPopup.prototype.Init = function () {
	this.InitEvents();
	this.InitLocation();
	this.InitOffers();
};
