			...
			<div class="component-body">
				...
				if(isset($arResult['FATAL_ERROR'])):?>
					<div class="component-header">
						<span class="component_title"><?=GetMessage("H2O_BUYONECLICK_FATAL_ERROR_TITLE")?></span>
					</div>
				...
				<? elseif($arResult['SUCCESS']): ?>
					...
					<div class="component-header">
						<span class="component_title"><?=$success_head?></span>
					</div>
					<div class="component-container">
					...
					<form action="<?=POST_FORM_ACTION_URI?>" class="buy_one_click_form" method="post" id="buy_one_click_form"
						...
						<? if(is_array($arResult['OFFERS']) && !empty($arResult['OFFERS']) && $arParams["SHOW_OFFERS_FIRST_STEP"] != 'Y'): ?>
							<div class="component-header">
								...
								<span class="component_title"><?=GetMessage("OFFERS")?></span>
							</div>
							<div class="component-container">
						...
						<? else: ?>
							<div class="component-header">
								...
								<br/>
								<span class="component_title"><?=GetMessage("PERSONAL")?></span>
							</div>
							<div class="component-container">
								...
								<? if(is_array($arResult['OFFERS']) && !empty($arResult['OFFERS'])): ?>
									<div class="component-header">
										<span class="component_title"><?=GetMessage("H2O_BUY_ONECLICK_OFFERS_TITLE")?></span>
									</div>
									<ul class="offers_list">
								...
								<? if(count($arResult['PAY_SYSTEM']) > 1 && $arParams['MODE_EXTENDED'] == 'Y' && $arParams['SHOW_PAY_SYSTEM']){
									?>
									<div class="component-header">
										<span class="component_title"><?=GetMessage("PAY_SYSTEM")?></span>
									</div>
									<div class="form-row">
								...
								<? if(count($arResult['DELIVERY']) > 1 && $arParams['MODE_EXTENDED'] == 'Y' && $arParams['SHOW_DELIVERY']){
									?>
									<div class="component-header">
										<span class="component_title"><?=GetMessage("DELIVERY")?></span>
									</div>
									<div class="form-row">
