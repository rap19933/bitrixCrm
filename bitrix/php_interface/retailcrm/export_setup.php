<?
    ...
    $iblockProperties = array(
        ...
        "height" => "height",
        "material" => "material",
        "second_icml_prop" => "second_icml_prop",
    );
    ...
    <form method="post" action="<?php echo $APPLICATION->GetCurPage(); ?>" >
        ...
        $iblockPropertiesName = Array(
            ...
            "material" => GetMessage("PROPERTY_MATERIAL_HEADER_NAME"),
            "second_icml_prop" => GetMessage("PROPERTY_SECOND_ICML_PROP_HEADER_NAME"),
        );
        ...
        $iblockPropertiesHint = Array(
            ...
            "material" => Array("STUFF", "MATERIAL"),
            "second_icml_prop" => Array("SECOND_ICML_PROP"),
        );
